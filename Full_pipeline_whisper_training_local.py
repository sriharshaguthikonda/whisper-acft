...
STAGE11_STAGE_NAME = _kaggle_safe_stage_token("frequency_shift")
...
log(
    ...
    f"s9={STAGE9_STAGE_NAME}, s10b={STAGE10B_STAGE_NAME}, s11={STAGE11_STAGE_NAME}"
)
...
if should_run("stage_11", [STAGE11_MANIFEST]):
    ...
    run_stage([PY, "stage_11_add_frequency_manipulation_idempotent.py",
         ...
         "--workers", str(AUG_WORKERS),
         "--stage_name", STAGE11_STAGE_NAME,
         "--seen_db", f"{SEEN_DIR}/stage11_{STAGE11_STAGE_NAME}.sqlite",
         "--semitones_min", "-1.0",
         "--semitones_max", "1.0",
         "--mode", "choice",
