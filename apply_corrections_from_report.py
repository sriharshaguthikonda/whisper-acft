#!/usr/bin/env python3
"""apply_corrections_with_conflict_flags.py
...
Usage
-----
python apply_corrections_with_conflict_flags.py \
  ...
  --mode auto \
  --strict_words \
  --conflicts-files "I:\\P2GPT_google_drive\\My Drive\\Transcriptions_corrected\\apply_corrections_from_report_conflicts_files.txt" \
  --conflicts-csv "I:\\P2GPT_google_drive\\My Drive\\Transcriptions_corrected\\apply_corrections_from_report_conflicts_segments.csv"
