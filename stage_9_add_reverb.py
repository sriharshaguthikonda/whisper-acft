...
i:\Whisper-training-env\Scripts\python.exe i:\whisper-acft\stage_9_add_reverb.py `
  --in_manifest "I:\Record_chunks\pairs_manifest_filtered_with_noises_and_others_voices_mixed_aug_gain.jsonl" `
  --rir_dir "I:\noise\RIRS_NOISES\real_rirs_isotropic_noises" `
  --out_audio_dir "I:\Record_chunks_aug_rir_real" `
  --out_manifest "I:\Record_chunks\pairs_manifest_filtered_with_noises_and_others_voices_mixed_aug_gain_aug_rir_real.jsonl" `
  --copies 1 --p 0.2 `
