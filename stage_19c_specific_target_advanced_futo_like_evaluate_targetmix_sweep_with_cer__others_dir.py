...
I:\Whisper-training-env\Scripts\python.exe "I:\whisper-acft\stage_19c_specific_target_advanced_futo_like_evaluate_targetmix_sweep_with_cer__others_dir.py" \
  --test_manifest "I:\Record_chunks\pairs_pending_stereo_english_only_filtered_with_others_voice_mix_aug_rir_real_bottom_filtered_randomized_test.jsonl" \
  --speaker_scores_csv "I:\Record_chunks\speaker_sort_scores.csv" \
  --others_dir "I:\Record_others_chunks" \
  --others_manifest "I:\Record_others_chunks\pairs_manifest_stereo.jsonl" \
